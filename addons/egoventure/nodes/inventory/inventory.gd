...
func _ready():
	$Canvas/InventoryAnchor/Panel/InventoryPanel/Money.add_color_override("font_color", Color(1, 1, 1, 1))
	$Canvas/InventoryAnchor/Panel/InventoryPanel/Money.text = str((EgoVenture.state as GameState).money)
